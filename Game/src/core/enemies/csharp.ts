...
export class CSharp extends Enemy<CSharp> {
    ...
    public create(x: number, y: number): CSharp {
        super.create(x, y, 'csharplogo')
    ...
    public withRouteLoop(moveTo: number, loopDelay: number, speed?: number): CSharp {
