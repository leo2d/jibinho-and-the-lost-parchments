...
export class Javascript extends Enemy<Javascript> {
    ...
    public create(x: number, y: number): Javascript {
        super.create(x, y, 'jslogo')
    ...
    public withRouteLoop(moveTo: number, loopDelay: number, speed?: number): Javascript {
